            ...
            <div class="col-lg-12 col-sm-9 col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="color : red; font-weight: 500; font-size: 20px;">Active Product</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example2" class="search-data table table-bordered table-hover">
                            <thead>
                                <tr>
                                    @can('post.id')
                                    <th>ID</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!--        style="font-size:12px; color: green;"></i></a>-->
                                                 ...
                                                 <a href="{{route('post.view.show', $post->slug)}}" target="_blank">
